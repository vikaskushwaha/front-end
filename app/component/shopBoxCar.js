...
const ShopBoxCar = () => {
    ...
    const fetchBrandsByCondition = async (condition) => {
        ...
        try {
            try {
                const response = await axios.get(`http://localhost:8080/api/v1/vehicle?condition=${condition}`);
                if (response.data?.data) {
                    if (response.data.data.vehclesList) {
    ...
    const filterBrandsWithCars = async (brandsList, condition) => {
        ...
        for (const brand of brandsList) {
            try {
                const response = await axios.get(`http://localhost:8080/api/v1/vehicle?condition=${condition}&make=${encodeURIComponent(brand)}`);
    ...
    const fetchVehicleTypes = async () => {
        ...
        try {
            ...
            try {
                const response = await axios.get('http://localhost:8080/api/v1/vehicleTypes');
                if (response.data?.data) {
    ...
    const handleItemClick = async (item) => {
        ...
        try {
            ...
            const response = await axios.get(`http://localhost:8080/api/v1/vehicle?${queryParams}`);
